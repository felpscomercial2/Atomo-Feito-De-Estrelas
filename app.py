...
def compras_upload():
    ...
    try:
        ...
        if upload_id_existente:
            ...
            ultimo_upload_id = None  # comparação já foi feita no primeiro lote
        else:
            # Último upload (para comparação de novos produtos)
        ...
        # KPIs comparativos — só calcula no primeiro lote do upload
