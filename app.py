...
def compras_listar():
    ...
    try:
        ...
        cursor.execute("""
            SELECT codigoproduto, descricaoproduto, quantidademediavenda, marca, carimbodatahora
            FROM purchase_items
            WHERE uploadid = %s
            ORDER BY id
        """, [upload_id])
...
def compras_exportar():
    ...
    try:
        ...
        ws = wb.active
        ws.title = 'Compras'
        ws.append(['Data', 'Código', 'Produto', 'Quantidade', 'Fabricante'])
        for r in rows:
            ws.append([r['carimbodatahora'], r['codigoproduto'], r['descricaoproduto'],
