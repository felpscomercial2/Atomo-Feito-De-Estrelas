    ...
    def _warm():
        try:
            ...
            filtros = {
                ...
                'vendedores': sorted(list(set(q("SELECT DISTINCT vendedor FROM faturamento WHERE vendedor IS NOT NULL AND vendedor != '' ORDER BY vendedor") + q("SELECT nome FROM vendedores ORDER BY nome")))),
            }
