    ...
    try:
        ...
        if produtos:
            ...
            sql = (
                ...
                ' (SELECT c2.endereco FROM carteira c2 WHERE c2.cod_cliente = f.cod_cliente LIMIT 1) AS endereco,'
            ...
            sql = (
                ...
                ' MAX(f.cidade) AS cidade, MAX(f.uf) AS uf, MAX(f.bairro) AS bairro, MAX(c.endereco) AS endereco,'
