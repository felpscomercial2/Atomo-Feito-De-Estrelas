...
def pivot_clientes_novo():
    ...
    try:
        ...
        base_params = [cods, '', cods, 'Venda', 'Devolucao'] + periodo_params + unid_params + ['']

        # ---------- filtro de vendedor ----------
        vend_filter = ''
        vend_params = []
        if cods:
            # O vendedor e SEMPRE o dono do cliente na CARTEIRA.
            # Nota emitida por outro vendedor para cliente que nao esta na
            # carteira do filtrado NAO entra.
        ...
        if produtos:
            ...
            cart_zero   = ''
            zero_params = []
            # Base (unidade) selecionada: entram TODOS os clientes cadastrados
            # naquela base, tenham ou nao movimento no periodo.
            ...
            if cods or unidades:
                ...
                if unidades:
                    if cart_unid:
                        ...
                        # sem coluna de base na carteira: usa o historico completo
                        # de faturamento para saber a que base o cliente pertence
                        where_zero.append(
