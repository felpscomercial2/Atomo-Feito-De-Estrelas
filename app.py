    ...
    def _warm():
        try:
            ...
            filtros = {
                ...
                'vendedores': sorted(list(set(
                    [r['vendedor'] for r in q("SELECT DISTINCT vendedor FROM faturamento WHERE vendedor IS NOT NULL AND vendedor != \'\' ORDER BY vendedor")]
                    + [r['nome'] for r in q("SELECT nome FROM vendedores ORDER BY nome")]
                ))),
            }
